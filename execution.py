...
from transports import handle_npx_stdio, handle_http_stdio, handle_docker_stdio, _npx_process_lock, _npx_processes
...
async def cleanup_dead_processes():
    """Background task to periodically clean up dead npx processes."""
    while True:
        try:
